...
async def image_sender(message: types.Message):
    a=randint(1, 2)
    if a == 1:
        await message.answer_photo(open('C:\Users\User\Favorites\Pictures\dog.jpg', 'rb'))
    else:
        await message.answer_photo(open('C:\Users\User\Favorites\Pictures.jpg', 'rb'))
